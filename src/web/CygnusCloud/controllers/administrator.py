...
def subjects():
    ...
    if(request.args(0) == 'add'):              
        ...
        form = FORM(HR(),H2(T('Añadir un nueva asignatura')),DIV( T('Código: '),BR(),INPUT(_name = 'cod',_style="width:30%;"),_style="position:absolute;left:10%;"),
                ...
                DIV( T('Grupo: '),BR(),INPUT(_name ='group',_style="width:10%;"),_style="position:absolute;left:28%;"),
                DIV( T('Número de plazas: '),BR(),INPUT(_name ='placesNumber',_style="width:29%;"),_style="position:absolute;left:18%;")
                    ,BR(),BR(),BR(),
