...
def subjects():
    ...
    if(request.args(0) == 'add'):              
        #Creamos el primer formulario
        form = FORM(HR(),H2(T('Añadir un nueva asignatura')),DIV( T('Código: '),BR(),INPUT(_name = 'cod',_style="width:80px;"),_style="position:absolute;left:10%;"),
                DIV( T('Nombre: '),BR(),INPUT(_name ='name'),_style="position:absolute;left:18%;"),BR(),BR(),BR(),
                DIV( T('Año: '),BR(),INPUT(_name ='year',_style="width:70px;"),_style="position:absolute;left:10%;"),
                DIV( T('Curso: '),BR(),INPUT(_name ='curse',_style="width:50px;"),_style="position:absolute;left:18%;"),
                DIV( T('Grupo: '),BR(),INPUT(_name ='group',_style="width:50px;"),_style="position:absolute;left:24%;"),BR(),BR(),BR(),
...
def createSubjectsSearchForm(state):        
    ...
    form1 = FORM(HR(),H2(T('Buscar una asignatura')),DIV( T('Código: '),BR(),INPUT(_name = 'cod',_style="width:80px;"),_style="position:absolute;left:10%;"),
                DIV( T('Nombre: '),BR(),INPUT(_name ='name'),_style="position:absolute;left:18%;"),BR(),BR(),BR(),
                DIV( T('Año: '),BR(),INPUT(_name ='year',_style="width:70px;"),_style="position:absolute;left:10%;"),
                DIV( T('Curso: '),BR(),INPUT(_name ='curse',_style="width:50px;"),_style="position:absolute;left:18%;"),
                DIV( T('Grupo: '),BR(),INPUT(_name ='group',_style="width:50px;"),_style="position:absolute;left:24%;"),BR(),BR(),BR(),
