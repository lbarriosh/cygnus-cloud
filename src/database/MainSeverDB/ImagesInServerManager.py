...
class ImageServerManager(object):
    ...
    def __init__(self,sqlUser,sqlPass,serverId):
        '''
    ...
    def getServerImages(self):
        ...
        '''
        #Creamos la consulta encargada de extraer los datos
        sql = "SELECT imageId FROM ServerImages WHERE serverId = " + self.__serverId    
        #Ejecutamos el comando
    ...
    def getImageName(self,imageId):
        ...
        '''
        #Creamos la consulta encargada de extraer los datos
        sql = "SELECT name FROM Image WHERE imageId = " + imageId   
        #Ejecutamos el comando
        self.__cursor.execute(sql)
        #Recogemos los resultado
    ...
    def getImageDescription(self,imageId):
        ...
        '''
        #Creamos la consulta encargada de extraer los datos
        sql = "SELECT description FROM Image WHERE imageId = " + imageId   
        #Ejecutamos el comando
        self.__cursor.execute(sql)
        #Recogemos los resultado
        result=self.__cursor.fetchone()
    ...
    def setDescription(self,imageId,description):
        ...
        '''
        #Creamos la consulta encargada de extraer los datos
        sql = "UPDATE Image SET description = '"  + description + "' WHERE imageId = " + imageId
        #Ejecutamos el comando
        self.__cursor.execute(sql) 
...
def main():
    ...
    imageSM = ImageServerManager("CygnusCloud","cygnuscloud2012",serverId)
