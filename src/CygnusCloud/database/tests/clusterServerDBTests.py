...
class ClusterServerDBTests(unittest.TestCase):
    ...
    def test_vmBootCommands(self):
        ...
        self.__connector.registerVMBootCommand("Command1")
        sleep(2)
        result = self.__connector.getOldVMBootCommandID(1)
        self.assertEquals(result, "Command1", 'getOldVMBootCommand does not work')
        self.__connector.registerVMBootCommand("Command1")
        sleep(1)
        result = self.__connector.getOldVMBootCommandID(3)
        self.assertEquals(result, None, 'getOldVMBootCommand does not work')
        self.__connector.registerVMBootCommand("Command2")
        self.__connector.registerVMBootCommand("Command3")
        sleep(5)           
        result = self.__connector.getOldVMBootCommandID(3)        
        self.assertEquals(result, "Command1", 'getOldVMBootCommand does not work')
        result = self.__connector.getOldVMBootCommandID(3)        
        self.assertEquals(result, "Command2", 'getOldVMBootCommand does not work')
        result = self.__connector.getOldVMBootCommandID(3)        
        self.assertEquals(result, "Command3", 'getOldVMBootCommand does not work')
