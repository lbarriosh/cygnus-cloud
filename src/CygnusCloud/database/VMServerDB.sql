...
CREATE TABLE IF NOT EXISTS CompressionQueue(position INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, data VARCHAR(420) NOT NULL);
						
CREATE TABLE IF NOT EXISTS TransferQueue(position INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, data VARCHAR(230) NOT NULL);
						
CREATE TABLE IF NOT EXISTS ConnectionDataDictionary(dict_key VARCHAR(70) PRIMARY KEY, value VARCHAR(21) NOT NULL);
